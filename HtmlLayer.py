...
from DataClasses import course_info
from DataClasses import playlist_info
from DataClasses import video_info
...
class HtmlHandler(object):
    ...
    def get_course_list(cls):
        """ This will return a list of course_info objects found on the main page
        ...
        for course_node in courses_nodes:
            ...
            # lazy loading
            course.video_page_link = None
            # lazy loading
            course.course_number = None
            # lazy loading
            course.playlist_list = None
    ...
    def get_playlist_list(cls, course_video_page_link, course_id):
        """ This will return a list of playlist_info objects found on the course video page
            course_id is needed to store it also in playlist_info """
    ...
    def get_video_list(cls, course_id, curr_playlist_info):
        """ This will return a list of video_info from curr_playlist_info
        ...
        for video_div in html.fromstring(eval(videos_div)[0].replace('\\/', '/')).findall('div'):
            video = video_info()
    ...
    def get_video_link(cls, course_id, curr_playlist_info, video_playlist_id):
        ...
        response = eval(req1.replace('true', 'True').
        ...
        html_data = html.fromstring(eval(req2)['html'].replace('\\/', '/'))
